<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="hm2.aspx.cs" Inherits="Hotel_Management.hm2" %>
...
<asp:Button ID="Button2" runat="server" Text="BUY" OnClientClick="return showPurchaseConfirm();" />
                ...
                <asp:Button ID="Button3" runat="server" Text="add to cart"  OnClick="Button3_Click" CommandArgument='<%# Eval("PRODUCT_ID") %>' CommandName="addtocart"/>
                <asp:Button ID="view" runat="server" Text="view" OnClick="view_Click" CommandArgument='<%# Eval("PRODUCT_ID") %>' CommandName="viewdetails" />
